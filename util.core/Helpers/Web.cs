...
namespace Util.Core.Helpers {
    ...
    public static class Web {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static Util.Core.Webs.Clients.WebClient Client() {
            return new Util.Core.Webs.Clients.WebClient();
        }
        ...
        public static Util.Core.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class {
            return new Util.Core.Webs.Clients.WebClient<TResult>();
        }
